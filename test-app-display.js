// Test script to verify that the application is displaying correctly

const axios = require('axios');

async function testAppDisplay() {
    console.log('=== Testing Application Display ===\n');
    ...
    try {
        ...
        console.log(`   ✅ Page title: ${homeResponse.data.includes('<title>') ? 'Found' : 'Not found'}`);
        ...
        console.log(`   ✅ CSS content length: ${cssResponse.data.length} characters`);
        ...
        console.log('\n=== Application Display Test Results ===');
